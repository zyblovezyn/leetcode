...
public class WeekDaysTest {
    ...
    public void testGetDay_jp() throws Exception {
        Assert.assertEquals(WeekDays.Mon.getDay_jp(),"���j��");
        Assert.assertEquals(WeekDays.Tue.getDay_jp(),"�Ηj��");
        Assert.assertEquals(WeekDays.Wed.getDay_jp(),"���j��");
        Assert.assertEquals(WeekDays.Thu.getDay_jp(),"�ؗj��");
        Assert.assertEquals(WeekDays.Fri.getDay_jp(),"���j��");
        Assert.assertEquals(WeekDays.Sat.getDay_jp(),"�y�j��");
        Assert.assertEquals(WeekDays.Sun.getDay_jp(),"���j��");
    }
